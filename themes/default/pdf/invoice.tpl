...
<td style="width: 85%; text-align: right">
    <table style="width: 100%; font-size: 8pt;">
        <tr style="line-height:4px;">
            ...
            {if !$tax_excluded_display}
                <td style="background-color: #4D4D4D; color: #FFF; text-align: right; font-weight: bold; width: 10%">{l s='Unit Price' pdf='true'}
    ...
    <table style="width: 100%">
        ...
        {foreach from=$order_invoice->getOrderPaymentCollection() item=payment}
            {if ($payment->payment_method=="downPayment")}
                {$down_payment=$down_payment+$payment->amount}
                <tr style="line-height:5px;">
                    <td style="text-align: right; font-weight: bold">{l s='Down Payment(-)' pdf='true'}</td>
